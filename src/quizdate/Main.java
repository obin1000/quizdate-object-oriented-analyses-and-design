...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("u1: " + u1.getLikes());
        System.out.println("u2: " + u2.getLikes());
        System.out.println("u3: " + u3.getLikes());
        m.acceptMatch(u1,u2);
        m.acceptMatch(u1,u3);
        System.out.println("They got a match");
        System.out.println("u1: " + u1.getMatches());
        System.out.println("u2: " + u2.getMatches());
        m.removeMatch(u1,u2);
